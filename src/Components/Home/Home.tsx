    ...
    return (
        <div className="home">
            ...
            <div className="blob">
                ...
                <div>
                    <span>Внимательно осмотрите место угона на наличие каких-либо существенных улик.</span>
                </div>
                <img src={bike1} alt="bike" />
                <div>
                    <span>Cообщитe о краже велосипеда заполнив форму на нашем сайте.</span>
                </div>
